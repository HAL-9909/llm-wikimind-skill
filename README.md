...
**A CatDesk / OpenClaw skill for ingesting content into your [WikiMind](https://github.com/liuxiangmian/wikimind) knowledge base.**

[![ClawHub](https://img.shields.io/badge/ClawHub-wiki--ingest-blue?style=flat-square)](https://clawhub.ai/skills/wiki-ingest)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)

*Part of the [WikiMind](https://github.com/liuxiangmian/wikimind) ecosystem — a production implementation of [Karpathy's LLM Wiki pattern](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f).*
...
- [WikiMind](https://github.com/liuxiangmian/wikimind) installed and configured
...
```bash
# Via ClawHub
npx clawhub@latest install liuxiangmian/wikimind-skill
...
- [WikiMind](https://github.com/liuxiangmian/wikimind) — the knowledge base system this skill writes to
